...
public sealed class GetUsedByTool : ITool, IDisposable
{
    ...
    public string Description =>
        @"Find what uses a symbol (incoming edges). Shows reverse dependencies — who calls, inherits, or references this symbol.

USE CASES:
- Impact analysis: what breaks if I change this class/method?
